...
% Prepare the table and handle outliers
...
% --- Calculate Group Means and Consistent 95% CIs ---
...
% --- Calculate Overall Mean and Consistent 95% CI ---
...
figure;
hold on;
% Plot individual studies as points with standard error bars
...
% NEW BLOCK: Plot overall mean diamond (Red) with correct width for CI
...
% NEW BLOCK: Plot group mean diamonds (Blue) with correct width for CI

# sim-map
Schizophrenia Interneuron Metanalysis (SIM) Mapping: A meta-analysis of GABAergic interneuron pathology in schizophrenia. The present manuscript is currently in submission. The pre-print can be found at https://www.biorxiv.org/content/10.1101/2025.05.23.655812v2. Use of this data should properly cite the paper. Data include raw data for interneuron cell density and mRNA expression. Code is scripted for MATLAB_R2024a and other versions may have issues.
